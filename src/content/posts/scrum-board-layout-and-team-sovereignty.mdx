...
<Callout>
Instead of a tool for delivery, [the board] becomes a tool for tracking individual status.
</Callout>
...
<Callout>
A team truly gains sovereignty when they **collectively own the Value** and **individually own the Labor**.
</Callout>
...
<Callout>
We stop asking "What did you do?" and start asking "What does the Story need?"
</Callout>
