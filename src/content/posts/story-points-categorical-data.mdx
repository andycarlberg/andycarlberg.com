...
<Callout>
Story Points are fundamentally **categorical data** - labels of *relative size* - that we
*incorrectly* treat as **quantitative, interval data** for calculating velocity.
</Callout>
...
<Callout>
The smaller the story, the more information we have (or less is needed), the narrower the
window of completion time is.
</Callout>
